...
function watchFiles() {
  ...
  gulp.watch(paths.fonts.watch, { cwd: paths.fonts.root }, fonts);
...
const build = gulp.series(clean, gulp.series(gulp.parallel(images, styles, scripts, fonts), gulp.parallel(html_public)));
